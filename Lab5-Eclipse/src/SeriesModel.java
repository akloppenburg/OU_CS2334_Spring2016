...
public class SeriesModel extends Series {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2237671951115369330L;
	/**
	...
	// TODO: Override additional mutators from Series so that the view will know
	// when the model is changed (see above for examples)
	
	@Override
	public boolean replaceEpisode(Episode episode){
		boolean bool = super.replaceEpisode(episode);
		processEvent(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "replace episode"));
		return bool;
	}
	
	@Override
	public void loadEpisodeMap() throws ClassNotFoundException, IOException{
	...
	public void saveEpisodeMap() throws FileNotFoundException, IOException{
		...
		processEvent(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, "save episodes"));
	}
