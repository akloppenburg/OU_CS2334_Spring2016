...
public class NewsStoryListTest {
	...
	public void testNewsStoryAddAndGetEmptyNewspaperStory() {
		...
		NewspaperStory newspaperStory1 = new NewspaperStory(LocalDate.of(2000, 1, 15), "", 0, "", newsMaker, newsMaker);
	...
	public void testNewsStoryListAddAndGetNotEmptyNotDuplicateNewspaperStory() {
		...
		NewsStoryList newsStoryList1 = new NewsStoryList();
		NewspaperStory newspaperStory1 = new NewspaperStory(LocalDate.of(2001,4,20),"",0,"",newsMaker1,newsMaker1);
		NewspaperStory newspaperStory2 = new NewspaperStory(LocalDate.of(2001,4,21),"",1,"",newsMaker1,newsMaker1);
		newsStoryList1.add(newspaperStory1);
