...
public class Series {
	...
	// DONE: Add a method for printing to the console.
	...
	public void printEpisodes() {
		for (Episode episode : this.getEpisodeArray()) {
