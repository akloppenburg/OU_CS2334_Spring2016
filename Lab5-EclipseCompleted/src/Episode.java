...
public class Episode implements Serializable {
	// DONE: Make this class serializable

	/**
	 * Version number to ensure correct serialization. Because this is our first
	 * serializable version of this class, we start with version number 1.
	 */
